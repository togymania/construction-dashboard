...
export default function ContractDetailPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Back link */}
      <Link href={`/subcontractors/${subId}`} className="inline-flex items-center text-sm text-muted-foreground hover:text-foreground">
                ...
                {contract.subcontractor && (
                  <div className="flex items-start gap-1.5">
                    ...
                    <div>
                      ...
                      <Link href={`/subcontractors/${contract.subcontractor.id}`} className="font-medium hover:underline">{contract.subcontractor.name}</Link>
                    </div>
                  </div>
                )}
                {contract.project && (
